...
\author{\href{mailto:email@unifi.it}{Relatore}}
\date{data}
...
\verb|\footlinecolor{color}|
      ...
      \testcolor{maincolor}, \testcolor{sintefblu1}, 
      \testcolor{sintefblu2}, \testcolor{sintefred}
...
\begin{colorblock}[black]{sintefblu1}{Colour Blocks}
...
\small
\begin{verbatim}
\begin{colorblock}[black]{sintefblu1}{title}
content...
\end{colorblock}
\end{verbatim}
\end{colorblock}
The ``official'' colours of colour blocks are: \testcolor{sintefblu1}, 
\testcolor{maincolor}, and \testcolor{sintefred}.
\end{column}
\end{columns}
\end{frame}
...
\item There are ``official'' colours: \testcolor{maincolor}, 
\testcolor{sintefred}, \testcolor{sintefblu1}, 
\testcolor{sintefblu2}.
      \begin{itemize}
